...
Function OnTesterInitialized()
	...
	Set exec1 = New spCoreAll_ExecInterpose
	exec1.OnTesterInitialized

	Dim exec2 As IExecInterposeFunctions
	Set exec2 = New CommonCodeAndShee_ExecInterpose
	exec2.OnTesterInitialized
...
Function OnProgramFailedValidation()
	...
	Dim exec2 As IExecInterposeFunctions
	Set exec2 = New CommonCodeAndShee_ExecInterpose
	exec2.OnProgramFailedValidation
...
Function OnAlarmOccurred(alarmList As String)
	...
	Dim exec2 As IExecInterposeFunctions
	Set exec2 = New CommonCodeAndShee_ExecInterpose
	exec2.OnAlarmOccurred alarmList
